...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     syntax-checking
     themes-megapack
     (epitech :variables epitech-enable-c-style t)
     )
...
before packages are loaded."
  (require 'helm-mode) ;;temporary fix for helm not starting in develop version of spacemacs
